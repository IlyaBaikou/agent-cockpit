...
const snapshot = {
  ...
  messages: [{ id: "m1", space: "demo-space", thread: "demo-thread", kind: "human", author: "owner", content: "@{a:a} Обсудите совместимость с фронтендом. Пока без изменений кода.", createdAt: now },
